...
| | |
|---|---|
| Last completed unit | **D81** — W17 psychometric dashboard shell + provenance stamp. Handoff: `claude/day81-psychometric-dashboard-shell.md`. |
...
| Next queued | Calendar **D82** — W17 psychometric figure panes (next after shell). |
| Block | **W17** — Psychometric dashboards (in progress; D81 shell closed). |
...
- W17 per-kind artefact charts + PDF/CSV export — **open** (D82+)
